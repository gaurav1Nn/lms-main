...
//         <div className="flex items-center gap-5 mr-4 text-sm">
//           <a href="#courses" className="text-gray-700 hover:text-emerald-600 font-semibold transition-colors">Courses</a>
//           <a href="#why-us" className="text-gray-700 hover:text-emerald-600 font-semibold transition-colors">Why Us</a>
//         </div>
...
//       </div>
//       {/* For Phone Screens */}
//       <div className="md:hidden flex flex-col items-end gap-1.5 sm:gap-2 text-gray-500">
